...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -O -g -arch i386 -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_OPTION_USE_BZIP2 -DDARWIN_NO_CARBON -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
