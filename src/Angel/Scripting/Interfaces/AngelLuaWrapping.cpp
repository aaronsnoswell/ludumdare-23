...
#define SWIGTYPE_p_Message swig_types[16]
#define SWIGTYPE_p_MessageListener swig_types[17]
#define SWIGTYPE_p_MouseListener swig_types[18]
#define SWIGTYPE_p_ParticleActor swig_types[19]
#define SWIGTYPE_p_PhysicsActor swig_types[20]
#define SWIGTYPE_p_Preferences swig_types[21]
#define SWIGTYPE_p_Renderable swig_types[22]
#define SWIGTYPE_p_SoundDevice swig_types[23]
#define SWIGTYPE_p_Switchboard swig_types[24]
#define SWIGTYPE_p_SystemLog swig_types[25]
#define SWIGTYPE_p_TagCollection swig_types[26]
#define SWIGTYPE_p_TextActor swig_types[27]
#define SWIGTYPE_p_Touch swig_types[28]
#define SWIGTYPE_p_TouchListener swig_types[29]
#define SWIGTYPE_p_Tuning swig_types[30]
#define SWIGTYPE_p_Vec2i swig_types[31]
#define SWIGTYPE_p_Vec2ui swig_types[32]
#define SWIGTYPE_p_Vec3i swig_types[33]
#define SWIGTYPE_p_Vec3ui swig_types[34]
#define SWIGTYPE_p_Vector2 swig_types[35]
#define SWIGTYPE_p_Vector3 swig_types[36]
#define SWIGTYPE_p_World swig_types[37]
#define SWIGTYPE_p_std__setT_Actor_p_t swig_types[38]
#define SWIGTYPE_p_std__setT_MessageListener_p_t swig_types[39]
#define SWIGTYPE_p_std__setT_std__string_t swig_types[40]
#define SWIGTYPE_p_std__string swig_types[41]
#define SWIGTYPE_p_std__vectorT_Actor_p_t swig_types[42]
#define SWIGTYPE_p_std__vectorT_Touch_p_t swig_types[43]
#define SWIGTYPE_p_std__vectorT_Vec3ui_t swig_types[44]
...
static int _wrap_Color_FromInts__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("Color::FromInts",6,6)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Color::FromInts",1,"Color *");
  ...
  if(!lua_isnumber(L,5)) SWIG_fail_arg("Color::FromInts",5,"int");
  if(!lua_isboolean(L,6)) SWIG_fail_arg("Color::FromInts",6,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Color,0))){
    SWIG_fail_ptr("Color_FromInts",1,SWIGTYPE_p_Color);
  }
  ...
  result = (arg1)->FromInts(arg2,arg3,arg4,arg5,arg6);
  {
...
static int _wrap_Color_FromInts__SWIG_1(lua_State* L) {
  ...
  arg4 = (int)lua_tonumber(L, 4);
  arg5 = (int)lua_tonumber(L, 5);
  result = (arg1)->FromInts(arg2,arg3,arg4,arg5);
  {
    Color * resultptr = new Color((const Color &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Color,1); SWIG_arg++;
  }
...
static int _wrap_Color_FromInts__SWIG_2(lua_State* L) {
  ...
  arg3 = (int)lua_tonumber(L, 3);
  arg4 = (int)lua_tonumber(L, 4);
  result = (arg1)->FromInts(arg2,arg3,arg4);
  {
    Color * resultptr = new Color((const Color &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Color,1); SWIG_arg++;
  }
...
static int _wrap_Color_FromHexString(lua_State* L) {
  ...
  SWIG_check_num_args("Color::FromHexString",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Color::FromHexString",1,"Color *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("Color::FromHexString",2,"String");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Color,0))){
    SWIG_fail_ptr("Color_FromHexString",1,SWIGTYPE_p_Color);
  }
  
  (&arg2)->assign(lua_tostring(L,2),lua_strlen(L,2));
  result = (arg1)->FromHexString(arg2);
  {
    Color * resultptr = new Color((const Color &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Color,1); SWIG_arg++;
  }
    ...
    if (_v) {
      {
        ...
        void *ptr;
        if (SWIG_IsOK(SWIG_ConvertPtr(L,argv[1],(void**)&ptr,SWIGTYPE_p_Vector2,0))) 
        {
          _v = 1;
          naturalVector = true;
        }
        ...
        if (!naturalVector)
        {
          if (lua_istable(L, argv[1]) && (luaL_getn(L, argv[1]) >= 2))
          {
      ...
      if (_v) {
        {
          bool naturalVector = false;
          void *ptr;
          if (SWIG_IsOK(SWIG_ConvertPtr(L,argv[2],(void**)&ptr,SWIGTYPE_p_Vector2,0))) 
          {
            _v = 1;
            naturalVector = true;
          }
          ...
          if (!naturalVector)
          {
            if (lua_istable(L, argv[2]) && (luaL_getn(L, argv[2]) >= 2))
            {
              // verify that at least the first two elements of the table contain numbers
              lua_pushinteger(L, 1);
          ...
          if (_v) {
            {
              ...
              void *ptr;
              if (SWIG_IsOK(SWIG_ConvertPtr(L,argv[4],(void**)&ptr,SWIGTYPE_p_Color,0))) 
              {
                _v = 1;
                naturalColor = true;
              }
              ...
              if (!naturalColor)
              {
                if (lua_istable(L, argv[4]) && (luaL_getn(L, argv[4]) >= 3))
                {
        ...
        if (_v) {
          {
            bool naturalVector = false;
            void *ptr;
            if (SWIG_IsOK(SWIG_ConvertPtr(L,argv[3],(void**)&ptr,SWIGTYPE_p_Vector2,0))) 
            {
              _v = 1;
              naturalVector = true;
            }
            ...
            if (!naturalVector)
            {
              if (lua_istable(L, argv[3]) && (luaL_getn(L, argv[3]) >= 2))
              {
                // verify that at least the first two elements of the table contain numbers
                lua_pushinteger(L, 1);
...
static int _wrap_MouseListener_MouseMotionEvent(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("MouseListener::MouseMotionEvent",2,"Vec2i");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_Vec2i,0))){
    SWIG_fail_ptr("MouseListener_MouseMotionEvent",2,SWIGTYPE_p_Vec2i);
  }
  arg2 = *argp2;
...
static int _wrap_MouseListener_MouseDownEvent(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("MouseListener::MouseDownEvent",2,"Vec2i");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_Vec2i,0))){
    SWIG_fail_ptr("MouseListener_MouseDownEvent",2,SWIGTYPE_p_Vec2i);
  }
  arg2 = *argp2;
...
static int _wrap_MouseListener_MouseUpEvent(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("MouseListener::MouseUpEvent",2,"Vec2i");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_Vec2i,0))){
    SWIG_fail_ptr("MouseListener_MouseUpEvent",2,SWIGTYPE_p_Vec2i);
  }
  arg2 = *argp2;
    ...
    if (_v) {
      {
        bool naturalColor = false;
        void *ptr;
        if (SWIG_IsOK(SWIG_ConvertPtr(L,argv[1],(void**)&ptr,SWIGTYPE_p_Color,0))) 
        {
          _v = 1;
          naturalColor = true;
        }
        ...
        if (!naturalColor)
        {
          if (lua_istable(L, argv[1]) && (luaL_getn(L, argv[1]) >= 3))
          {
            // verify that at least the first three elements of the table contain numbers
            lua_pushinteger(L, 1);
            lua_gettable(L, argv[1]);
...
{ SWIG_LUA_INT,     (char *)"MOUSE_LEFT", (long) MOUSE_LEFT, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"MOUSE_MIDDLE", (long) MOUSE_MIDDLE, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"MOUSE_RIGHT", (long) MOUSE_RIGHT, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"TOUCH_START", (long) TOUCH_START, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"TOUCH_END", (long) TOUCH_END, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"TOUCH_MOVE", (long) TOUCH_MOVE, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"SAT_None", (long) SAT_None, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"SAT_Loop", (long) SAT_Loop, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"SAT_PingPong", (long) SAT_PingPong, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"SAT_OneShot", (long) SAT_OneShot, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"ADS_Square", (long) ADS_Square, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"ADS_Circle", (long) ADS_Circle, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"PhysicsActor_SHAPETYPE_BOX", (long) PhysicsActor::SHAPETYPE_BOX, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"PhysicsActor_SHAPETYPE_CIRCLE", (long) PhysicsActor::SHAPETYPE_CIRCLE, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"TXT_Left", (long) TXT_Left, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"TXT_Center", (long) TXT_Center, 0, 0, 0},
{ SWIG_LUA_INT,     (char *)"TXT_Right", (long) TXT_Right, 0, 0, 0},
    {0,0,0,0,0,0}
};
